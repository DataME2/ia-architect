...
| **Player finance** | Player, Parent/Guardian, Finance Admin, Treasurer | Fees, payment plans, installments, vouchers — state government youth-sport voucher programs, each enabled for a club only with Committee approval, applied and claimed only by Finance Admin or Treasurer — reconciliation (C3) | [Payment plan process](./3_business-processes.md#payment-plan-process), [Voucher program enablement process](./3_business-processes.md#voucher-program-enablement-process), [Voucher application and claim process](./3_business-processes.md#voucher-application-and-claim-process) | **Payment plans delivered** (plans, instalments, recorded receipts, arrears-aware BR3 — see [scope 21](../../scope/21_payment-plans-and-the-registration-status.md)); vouchers, provider reconciliation and guardian notification still pending |
