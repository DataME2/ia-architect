...
| **Player finance** | Player, Parent/Guardian, Finance Admin, Treasurer | Fees, payment plans, installments, vouchers — state government youth-sport voucher programs, each enabled for a club only with Committee approval — reconciliation (C3) | [Payment plan process](./3_business-processes.md#payment-plan-process), [Voucher program enablement process](./3_business-processes.md#voucher-program-enablement-process) | Pending |
