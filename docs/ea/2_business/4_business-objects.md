...
| **Match Confirmation** | A Guardian's after-the-fact confirmation that a fixture their under-13 match official was appointed to actually happened and their child was there, with an optional score kept for statistics only — never the club's score of record, and never a substitute for BR119's payment verification (BR151) |
