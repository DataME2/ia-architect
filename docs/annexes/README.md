...
| [accessibility-audit.md](./accessibility-audit.md) | NFR-15 | WCAG 2.2 AA assessed by inspection across thirteen criteria. One defect found and fixed; **four criteria named unverified** — contrast, target size, focus visibility, reflow. **No screen-reader session has been run**, and that limit is stated first because an audit is exactly the artifact later cited as a clearance |
| [performance-budgets.md](./performance-budgets.md) | NFR-16 | The budgets, the load they are measured at (1,400 people, not 700 — a registration is a child *and* a guardian), and what is not measured: nothing against a database, nothing in a browser, nothing beyond one club |
| [backup-and-restore.md](./backup-and-restore.md) | NFR-17 | The RPO, RTO and retention, the procedure for the day it is needed, and what the rehearsal does **not** prove — Supabase's own backups, the real restore time, whether accounts survive, and the Storage bucket the photographs are in |
