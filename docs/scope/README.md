...
| 4   | [4_voucher-programs-and-committee-approval.md](./4_voucher-programs-and-committee-approval.md) | branch `claude/au-youth-sport-vouchers-jvdr4s` | Generalizes Voucher into multi-program Voucher Program (six AU state schemes) and adds Committee-approval rule BR21 gating which programs a club can use; records NZ's lack of an equivalent scheme; no code yet |
