...
| `0040` | A person reads the committee office they hold, and the term behind it — an elected officer with no `club_membership` row could not see their own election |
