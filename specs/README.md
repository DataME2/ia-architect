...
| [tasks.md](./tasks.md) | **What is left** — 213 checkboxed tasks in 15 phases — 158 of them already done, each referencing the requirement it satisfies and the design decision that shaped it |
